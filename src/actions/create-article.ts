...
export const createArticles = async (
  ...
  try {
    ...
    if (!imageUrl) {
      return {
        errors: {
          featuredImage: ["Failed to get image URL. Please try again."],
        },
      };
    }
  } catch (error) {
    ...
    return {
      errors: {
        featuredImage: ["An error occurred while processing the image. Please try again."],
      },
    };
  }
